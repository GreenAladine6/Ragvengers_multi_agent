...
async def main():
    ...
    parser.add_argument("--id-project", type=int, default=1, help="ID of the project in the database")
    ...
    print(f"Project ID: {args.id_project}")
    ...
    html_report = await orchestrator.generate_report(args.repo_url, args.id_project, args.files)
